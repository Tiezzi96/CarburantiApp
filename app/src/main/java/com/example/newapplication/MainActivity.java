...
public class MainActivity extends AppCompatActivity implements Serializable, OnMapReadyCallback, PermissionsListener, MapboxMap.OnMapClickListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionsMenu fuelmenu = (FloatingActionsMenu) findViewById(R.id.Menu_Carburanti);
        FrameLayout.LayoutParams lp3 = (FrameLayout.LayoutParams) fuelmenu.getLayoutParams();
        System.out.println("rapporto: "+(float)(dm.widthPixels));
        System.out.println("rapporto: "+(float)(dm.heightPixels)/85);
        //lp3.setMargins(0,0,(int)((float)(((float)(dm.widthPixels))/((float)(dm.widthPixels)/220))*scale+0.5f), (int)((float)(dm.heightPixels/((float)(dm.heightPixels)/85))*scale+0.5f));
        ...
        FrameLayout.LayoutParams lp4 = (FrameLayout.LayoutParams) recenterbutton.getLayoutParams();
        System.out.println("rapporto: "+(float)(dm.widthPixels));
        System.out.println("rapporto: "+(float)(dm.heightPixels)/85);
        //lp4.setMargins((int)(((float)(dm.widthPixels)/((float)(dm.widthPixels)/315))*scale+0.5f), (int)(((float)(((float)dm.heightPixels)/((float)(dm.heightPixels)/590)))*scale+0.5f), 0, 0);
        System.out.println(lp4.bottomMargin+" "+lp4.topMargin);
        System.out.println(lp3.bottomMargin+" "+lp3.topMargin);
        System.out.println("dm.heightPixels: "+dm.heightPixels+ "position height recenter button: "+(int)(((float)(((float)dm.heightPixels)/((float)(dm.heightPixels)/590)))*scale+0.5f));
